...
#hadoop jar confidence.jar Confidence -D confidence.case.sensitive=false /user/ehiga/confidence/input /user/ehiga/confidence/output -skip /user/ehiga/confidence/stop_words.txt
